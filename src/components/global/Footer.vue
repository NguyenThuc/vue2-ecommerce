          ...
          <b-row>
            <b-col md="4" class="mb-5">
              ...
              <div class="d-flex flex-column justify-content-start">
                ...
                >
                <a
                  class="text-secondary mb-2 text-decoration-none text-light"
                  href="#"
                  ><b-icon
                    icon="chevron-right"
                    class="me-1"
                ...
                >
                <a
                  class="text-secondary text-decoration-none mb-2 text-light"
                  href="#"
                  ><b-icon
                    icon="chevron-right"
                    class="me-1"
                ...
                >
                <a
                  class="text-secondary text-decoration-none text-light"
                  href="#"
                  ><b-icon
                    icon="chevron-right"
                    class="me-1"
